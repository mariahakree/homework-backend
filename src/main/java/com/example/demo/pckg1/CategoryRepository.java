 ...
 */
public HashMap<String, Integer> getKidsCountByCategoryPerPeriod(int period){
	...
	ArrayList<String> allCategories=getAllCategoriesIds();
	for(String catId : allCategories) {
		int categoryKids = 0;
